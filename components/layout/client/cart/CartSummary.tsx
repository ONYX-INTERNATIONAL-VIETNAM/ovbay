    ...
    <aside className="rounded-2xl border bg-white/70 p-5 backdrop-blur">
      ...
      <div className="mt-4 flex flex-col gap-2">
        <button
          ...
          disabled={subtotal <= 0}
          className="h-11 text-white rounded-xl bg-[var(--secondary-color)] px-5 text-sm font-medium text-slate-900 hover:bg-amber-400 disabled:cursor-not-allowed disabled:opacity-60"
        >
          Thanh toán
        </button>
        <button
